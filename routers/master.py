...
@router.get("/GetMrs/{ُLID}", response_model= schemas.MasterOut, summary= "Get Master", description= "Getting professor information")
...
@router.post("/CreateMaster", response_model= schemas.Master, summary= "Create Master", description= "Create a master user")
...
@router.patch("/Updmaster/{LID}", response_model= schemas.UpdateMaster, summary= "Update Master", description= "Update a master user")
...
@router.delete("/DelLsn/{LID}", summary= "Delete Master", description= "Delete a master user")
