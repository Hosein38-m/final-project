...
@router.get("/getcsr/{CID}", response_model= schemas.Lesson, summary= "Get Course", description="Getting course information")
...
@router.post("/creatcsr", response_model= schemas.Lesson, summary= "Create Course", description="Create a course ")
...
@router.patch("/uptcsr/{CID}", response_model=schemas.UpdateLesson, summary= "Update Course", description= "Update a course")
...
@router.delete("/Delcsr/{CID}", summary= "Delete Course", description= "Delete a course")
