...
@router.get("/GetStu/{ُSTID}", response_model=schemas.Student, summary= "Get Student", description= "Getting a student information")
...
@router.post("/RegStu", response_model= schemas.Student, summary= "Create Student", description= "Create a student user")
...
@router.patch("/UpdStu/{STID}", summary= "Update Student", description= "Update a student user")
...
@router.delete("/DelStu/{STID}", summary= "Delete Student ", description= "Delete a student user")
